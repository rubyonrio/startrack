# Startrack Tracker: [![Build Status][bimg]][blink] [![Code Climate][codeclimateimg]][codeclimatelink] [![Inline docs](http://inch-ci.org/github/rubyonrio/startrack.png)](http://inch-ci.org/github/rubyonrio/startrack)
